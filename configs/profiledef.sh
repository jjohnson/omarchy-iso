...
#
# The stock x86_64 kernel supports SquashFS zstd and benefits from its much
# faster cold-read decompression. Arch Linux ARM's linux-aarch64 kernel omits
# CONFIG_SQUASHFS_ZSTD, so its live root must use the supported XZ decompressor.
...
file_permissions=(
  ...
  ["/usr/local/bin/omarchy-live-console-map"]="0:0:755"
